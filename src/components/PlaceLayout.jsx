          ...
          <div className="flex flex-col lg:flex-row gap-8 bg-gray-100 p-6 rounded-2xl">
            ...
            <div className="lg:w-1/3">
              <form
                ...
                className="sticky top-24 flex flex-col gap-4 bg-white p-6 rounded-2xl shadow-lg">
                <input
                  type="text"
                  name="fullName"
                  ...
                  required
                  className="input-style border rounded-lg p-1"
                />
                <input
                  type="tel"
                  name="phone"
                ...
                <div className="flex gap-3">
                  <div className="w-1/2">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="input-style w-full border rounded-lg p-1"
                    />
                  </div>
                  <div className="w-1/2">
