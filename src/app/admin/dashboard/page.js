    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm p-6">
          <h2 className="text-lg font-semibold mb-5">Recent Treks</h2>

          <div className="space-y-4">
            <div className="flex justify-between items-center border-b pb-3">
              <div>
                <h3 className="font-medium">Kedarkantha Trek</h3>
            ...
            <div className="flex justify-between items-center border-b pb-3">
              <div>
                <h3 className="font-medium">Har Ki Dun Trek</h3>
      ...
      {/* Recent Blogs */}
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <h2 className="text-lg font-semibold mb-5">Recent Blog Articles</h2>

        <div className="space-y-4">
          <div className="flex justify-between border-b pb-3">
            <div>
              <h3 className="font-medium">Best Treks in Uttarakhand</h3>

              <p className="text-sm text-gray-500">Published on 22 June 2026</p>
            </div>
          ...
          <div className="flex justify-between">
            <div>
              <h3 className="font-medium">Kedarkantha Trek Guide</h3>
      ...
      {/* SEO Overview */}
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <h2 className="text-lg font-semibold mb-5">SEO Overview</h2>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="border rounded-xl p-4">
            <p className="text-gray-500">Missing Meta Titles</p>
            <h3 className="text-2xl font-bold text-red-500">2</h3>
          </div>

          <div className="border rounded-xl p-4">
            <p className="text-gray-500">Missing Descriptions</p>
